...
% Source: egreg
% https://tex.stackexchange.com/questions/405132/how-to-make-every-line-in-a-bubble-like-chat-conversations

\newlength{\bubblesep}
\newlength{\bubblewidth}
\setlength{\bubblesep}{2pt}
\AtBeginDocument{\setlength{\bubblewidth}{.9\textwidth}}
