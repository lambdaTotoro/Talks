...
\pause\item Make sure you \emph{understand} the question you're asking.
\end{itemize}
\bigskip\medskip

\pause\emph{And then ask!} Tell them, what you need the answer for and give as many options as is reasonable under the circumstances (that's \emph{almost always} more than 2!) but also leave a text field for people who don't find themselves in those options.
\end{frame}
