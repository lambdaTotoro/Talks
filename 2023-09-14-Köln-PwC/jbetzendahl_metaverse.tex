...
\end{center}
\Put(330,0){\includegraphics[width=0.2\textwidth,keepaspectratio]{images/noun-telescope.png} }
\end{frame}
...
``\emph{The} Metaverse \emph{is a collection of connected virtual spaces that allow users to interact with their digital environment and other users.
\medskip
...
\end{minipage}
\pause
\Put(0,0){\includegraphics[width=0.4\textwidth,keepaspectratio]{images/cute_alien_speech_vague.png} }
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\textwidth,keepaspectratio]{images/pokemon-go-ar1.jpg} 
\end{center}
\pause
\Put(20,260){\rotatebox{-6}{\includegraphics[width=0.85\textwidth,keepaspectratio]{images/pokemon-go-ar2.jpg}}}
\end{frame}
...
\begin{center}
\includegraphics[height=0.65\textheight,keepaspectratio]{images/hype_cycle.jpg} 
\end{center}
\end{frame}
